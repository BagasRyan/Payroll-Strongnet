                    ...
                    <div class="card-body">
                        <form action="{{ route('karyawan.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $karyawan->nama }}" name="nama" id="nama">
                                ...
                                <input type="text" class="form-control" value="{{ $karyawan->gaji_pokok }}" name="gajiPokok" id="nama">
                            </div>
